...
<body>
    ...
    <div class="content">
        <p>Bahwa yang bersangkutan merupakan benar warga yang berdomisili di Desa {{ \App\Models\PengaturanDesa::get('nama_desa', 'Avara') }}, Kecamatan {{ \App\Models\PengaturanDesa::get('kecamatan', '-') }}, Kabupaten {{ \App\Models\PengaturanDesa::get('kabupaten', '-') }} yang telah tinggal selama <strong>{{ $data_isian['lama_tinggal'] ?? ($data_isian['Lama Tinggal'] ?? '-') }} tahun</strong>.</p>
