...
<body>
    ...
    <div class="content">
        <p>Bahwa yang bersangkutan bermaksud mengajukan permohonan pembuatan KTP dengan jenis permohonan <strong>{{ $data_isian['jenis_permohonan'] ?? ($data_isian['Jenis Permohonan'] ?? '-') }}</strong>.</p>
        
        <p>Surat pengantar ini dibuat untuk keperluan pengurusan KTP di Dinas Kependudukan dan Catatan Sipil.</p>
