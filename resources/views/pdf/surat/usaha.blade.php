...
<body>
    ...
    <div class="content">
        <p>Bahwa yang bersangkutan memiliki usaha dengan keterangan sebagai berikut:</p>
    </div>
    ...
    <div class="biodata">
        <table>
            <tr>
                <td>Nama Usaha</td>
                <td>:</td>
                <td><strong>{{ $data_isian['nama_usaha'] ?? ($data_isian['Nama Usaha'] ?? '-') }}</strong></td>
            </tr>
            <tr>
                <td>Jenis Usaha</td>
                <td>:</td>
                <td>{{ $data_isian['jenis_usaha'] ?? ($data_isian['Jenis Usaha'] ?? '-') }}</td>
            </tr>
            <tr>
                <td>Alamat Usaha</td>
                <td>:</td>
                <td>{{ $data_isian['alamat_usaha'] ?? ($data_isian['Alamat Usaha'] ?? '-') }}</td>
            </tr>
            <tr>
                <td>Tahun Berdiri</td>
                <td>:</td>
                <td>{{ $data_isian['tahun_berdiri'] ?? ($data_isian['Tahun Berdiri'] ?? '-') }}</td>
            </tr>
        </table>
    </div>

    <div class="content">
        <p>Surat keterangan ini dibuat untuk keperluan <strong>{{ $data_isian['keperluan'] ?? ($data_isian['Keperluan'] ?? 'pengurusan izin usaha') }}</strong>.</p>
