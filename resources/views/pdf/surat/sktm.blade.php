...
<body>
    ...
    <div class="content">
        <p>Bahwa yang bersangkutan merupakan benar warga yang berdomisili di Desa {{ \App\Models\PengaturanDesa::get('nama_desa', 'Avara') }}, Kecamatan {{ \App\Models\PengaturanDesa::get('kecamatan', '-') }}, Kabupaten {{ \App\Models\PengaturanDesa::get('kabupaten', '-') }} yang tergolong <strong>TIDAK MAMPU</strong> secara ekonomi.</p>
