...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-login-warga">Memproses login warga menggunakan NIK & No KK via API.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-login-admin">
                                <a href="#endpoints-POSTapi-v1-auth-login-admin">Memproses login administrator menggunakan Username & Password via API.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-informasi">
                                <a href="#endpoints-GETapi-v1-informasi">Mengambil daftar seluruh artikel informasi publik yang telah terbit.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-informasi--slug-">
                                <a href="#endpoints-GETapi-v1-informasi--slug-">Menampilkan detail informasi publik tertentu berdasarkan slug.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-statistik-demografi">
                                <a href="#endpoints-GETapi-v1-statistik-demografi">Mengambil rangkuman data demografi kependudukan desa.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-statistik-layanan">
                                <a href="#endpoints-GETapi-v1-statistik-layanan">Mengambil rangkuman data statistik statistik layanan administrasi persuratan.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-verifikasi--hash-">
                                <a href="#endpoints-GETapi-v1-verifikasi--hash-">Memverifikasi tanda tangan digital surat berdasarkan hash QR Code.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-telegram-webhook">
                                <a href="#endpoints-POSTapi-v1-telegram-webhook">Endpoint utama penerima payload webhook Telegram.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-logout">
                                <a href="#endpoints-POSTapi-v1-auth-logout">Memproses keluar log (logout) dengan menghapus token akses saat ini.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-auth-profile">
                                <a href="#endpoints-GETapi-v1-auth-profile">Mengambil detail informasi profil pengguna yang sedang login.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-bind-telegram">
                                <a href="#endpoints-POSTapi-v1-auth-bind-telegram">Menghubungkan ID chat Telegram dengan akun warga.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-surat-kategori">
                                <a href="#endpoints-GETapi-v1-surat-kategori">Mengambil daftar seluruh kategori surat yang aktif untuk diajukan.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-surat-kategori--id-">
                                <a href="#endpoints-GETapi-v1-surat-kategori--id-">Mengambil spesifikasi skema data dan syarat dari satu kategori surat.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-surat-pengajuan">
                                <a href="#endpoints-POSTapi-v1-surat-pengajuan">Memproses pengiriman permohonan pengajuan surat pelayanan baru dari warga.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-surat-pengajuan">
                                <a href="#endpoints-GETapi-v1-surat-pengajuan">Mengambil daftar riwayat permohonan surat milik warga yang sedang login.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-surat-pengajuan--id-">
                                <a href="#endpoints-GETapi-v1-surat-pengajuan--id-">Mengambil detail dari permohonan surat tertentu beserta riwayat tracking-nya.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-mutasi">
                                <a href="#endpoints-POSTapi-v1-mutasi">Memproses pengajuan mutasi penduduk baru (kelahiran/kematian/kedatangan/kepindahan).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-mutasi">
                                <a href="#endpoints-GETapi-v1-mutasi">Mengambil daftar riwayat mutasi milik warga yang sedang login.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-admin-surat-pengajuan">
                                <a href="#endpoints-GETapi-v1-admin-surat-pengajuan">Mengambil data seluruh pengajuan surat untuk kebutuhan panel admin desa.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-surat-pengajuan--id--approve">
                                <a href="#endpoints-POSTapi-v1-admin-surat-pengajuan--id--approve">Menyetujui pengajuan surat dan memicu proses tanda tangan digital PDF otomatis.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-surat-pengajuan--id--reject">
                                <a href="#endpoints-POSTapi-v1-admin-surat-pengajuan--id--reject">Menolak pengajuan permohonan surat warga dengan menyertakan catatan penolakan.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-admin-mutasi">
                                <a href="#endpoints-GETapi-v1-admin-mutasi">Mengambil seluruh data mutasi penduduk untuk panel admin desa.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-mutasi--id--approve">
                                <a href="#endpoints-POSTapi-v1-admin-mutasi--id--approve">Menyetujui pengajuan mutasi dan memperbarui status aktif/pasif kependudukan warga terkait.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-mutasi--id--reject">
                                <a href="#endpoints-POSTapi-v1-admin-mutasi--id--reject">Menolak pengajuan mutasi penduduk.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-admin-informasi">
                                <a href="#endpoints-GETapi-v1-admin-informasi">Mengambil daftar informasi publik untuk keperluan panel admin (termasuk draf).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-informasi">
                                <a href="#endpoints-POSTapi-v1-admin-informasi">Menyimpan artikel informasi publik baru ke database.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-admin-informasi--id-">
                                <a href="#endpoints-PUTapi-v1-admin-informasi--id-">Memperbarui detail artikel informasi publik tertentu berdasarkan ID.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-admin-informasi--id-">
                                <a href="#endpoints-DELETEapi-v1-admin-informasi--id-">Menghapus artikel informasi publik tertentu dari database.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-statistik-clear-cache">
                                <a href="#endpoints-POSTapi-v1-admin-statistik-clear-cache">Membersihkan cache penyimpanan data statistik.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: July 4, 2026</li>
    </ul>
</div>
...
<p>Untuk mendapatkan token, login terlebih dahulu menggunakan endpoint <code>POST /api/v1/auth/login/warga</code> (untuk warga) atau <code>POST /api/v1/auth/login/admin</code> (untuk admin). Token yang didapat kemudian digunakan sebagai Bearer token di header Authorization.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-v1-auth-login-warga">Memproses login warga menggunakan NIK &amp; No KK via API.</h2>
...
<p>Must be 16 characters. Example: <code>aykcmyuwpwlvqwrs</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-login-admin">Memproses login administrator menggunakan Username &amp; Password via API.</h2>
...
<p>Example: <code>|]|{+-</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-informasi">Mengambil daftar seluruh artikel informasi publik yang telah terbit.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-informasi--slug-">Menampilkan detail informasi publik tertentu berdasarkan slug.</h2>
...
<p>The slug of the informasi. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-statistik-demografi">Mengambil rangkuman data demografi kependudukan desa.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-statistik-layanan">Mengambil rangkuman data statistik statistik layanan administrasi persuratan.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-verifikasi--hash-">Memverifikasi tanda tangan digital surat berdasarkan hash QR Code.</h2>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-telegram-webhook">Endpoint utama penerima payload webhook Telegram.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-logout">Memproses keluar log (logout) dengan menghapus token akses saat ini.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-auth-profile">Mengambil detail informasi profil pengguna yang sedang login.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-bind-telegram">Menghubungkan ID chat Telegram dengan akun warga.</h2>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-surat-kategori">Mengambil daftar seluruh kategori surat yang aktif untuk diajukan.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-surat-kategori--id-">Mengambil spesifikasi skema data dan syarat dari satu kategori surat.</h2>
...
<p>The ID of the kategori. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-surat-pengajuan">Memproses pengiriman permohonan pengajuan surat pelayanan baru dari warga.</h2>
...
<small>object</small>&nbsp;
 ...
 &nbsp;
    ...
    <br>
                    ...
                    <h2 id="endpoints-GETapi-v1-surat-pengajuan">Mengambil daftar riwayat permohonan surat milik warga yang sedang login.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-surat-pengajuan--id-">Mengambil detail dari permohonan surat tertentu beserta riwayat tracking-nya.</h2>
...
<p>The ID of the pengajuan. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-mutasi">Memproses pengajuan mutasi penduduk baru (kelahiran/kematian/kedatangan/kepindahan).</h2>
...
<div class="bash-example">
    ...
    \"tanggal_mutasi\": \"2026-07-04T17:42:57\",
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="2026-07-04T17:42:57"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-07-04T17:42:57</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-mutasi">Mengambil daftar riwayat mutasi milik warga yang sedang login.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-admin-surat-pengajuan">Mengambil data seluruh pengajuan surat untuk kebutuhan panel admin desa.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-surat-pengajuan--id--approve">Menyetujui pengajuan surat dan memicu proses tanda tangan digital PDF otomatis.</h2>
...
<p>The ID of the pengajuan. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-surat-pengajuan--id--reject">Menolak pengajuan permohonan surat warga dengan menyertakan catatan penolakan.</h2>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-admin-mutasi">Mengambil seluruh data mutasi penduduk untuk panel admin desa.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-mutasi--id--approve">Menyetujui pengajuan mutasi dan memperbarui status aktif/pasif kependudukan warga terkait.</h2>
...
<p>The ID of the mutasi. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-mutasi--id--reject">Menolak pengajuan mutasi penduduk.</h2>
...
<p>The ID of the mutasi. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-admin-informasi">Mengambil daftar informasi publik untuk keperluan panel admin (termasuk draf).</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-informasi">Menyimpan artikel informasi publik baru ke database.</h2>
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-admin-informasi--id-">Memperbarui detail artikel informasi publik tertentu berdasarkan ID.</h2>
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-admin-informasi--id-">Menghapus artikel informasi publik tertentu dari database.</h2>
...
<p>The ID of the informasi. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-statistik-clear-cache">Membersihkan cache penyimpanan data statistik.</h2>
